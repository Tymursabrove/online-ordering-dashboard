  ...
  return (
    <Row style={{padding:15, margin:0, backgroundColor: color.primary}} className="justify-content-center">
      <p style={{textAlign: 'center'}}>
        ...
        <a style={{color:'white'}} target="_blank" rel="noopener noreferrer" href="/">Terms of Use</a>
        <b style={{color:'white'}}> | </b>
        <a style={{color:'white'}} target="_blank" rel="noopener noreferrer" href="/">Privacy Policy</a>
      </p>
