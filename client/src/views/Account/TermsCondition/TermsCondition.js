...
class TermsCondition extends Component {
  constructor(props) {
    ...
    this.state = {
      text: [
        {
          title: "1. Services by FoodieBee",
          descrip: [
            '1.1. On the website and via third parties\' internet presences, FoodieBee presents a selection of products, meals and services to Customers, which FoodieBee purchases from various local catering service providers ("Partner Caterers"), and provides a platform enabling a simple handling of orders and payments with FoodieBee.',
            "1.2. FoodieBee presents the Catering Services, in particular meals, of its Partner Caterers on the website and processes orders from customers as a reseller of these Partner Caterers. The meals are prepared by the Partner Caterers, with whom FoodieBee enters into separate Agreements, and supplied to the customer directly by the Partner Caterers on behalf of FoodieBee. This agreement only applies between the Customer and FoodieBee, the relevant Partner Caterer is not a party to this Agreement and therefore is not a contracting partner of the Customer."
          ]
        },
        {
          title: "2. Preconditions for orders from Customers",
          descrip: [
            `Customers using the services of FoodieBee
            - must be at least 18 years of age,
            - must be in a position to accept orders at the address stated in the order,
            - may under no circumstances sub-license, resell or hand over or provide the Catering Services offered via the website to third parties at a charge without written consent from FoodieBee,
            ...
            - must keep their login data secret and inform FoodieBee without delay as soon as there is the suspicion of a loss or theft of the login data.`
          ]
        },
        {
          ...
          descrip: [
            ...
            - by phone (the FoodieBee customer service is available Mon-Fri from 08:00 – 18:00 and Sat-Sun from 09:00 – 18:00) at +353 83 1861716, or
            ...
            "3.2. Approval of the registration is at FoodieBee' free discretion. If FoodieBee approves a registration, a matching customer profile is created.",
            "3.3. FoodieBee reserves the right to limit the Customer's access to the customer profile on the website at its own discretion."
          ]
        },
        {
          title: "4. Conclusion of the Agreement",
          descrip: [
            "4.1. The customer can place an order by phone or by using the relevant form on the website. Each order contains information about the selected Partner Caterer, its Catering Services, in particular meals and their quantity, the price and delivery details such as delivery date and location. The details of an order can also be coordinated with FoodieBee by phone.",
            ...
            '4.3. An Agreement is only concluded by the transmission of a separate order confirmation from FoodieBee (Re.: "Confirmation of your FoodieBee order") within two days of the offer by the Customer.',
            '4.5. FoodieBee stores the terms of the Agreement, i.e. the Customer\'s order data and the T&Cs, and sends the order data to the Customer in the order confirmation. The T&Cs are attached to the order confirmation (Re.: "Confirmation of your FoodieBee order") as a PDF.',
        ...
        },
        {
          ...
          descrip: [
            "5.1. The Catering Services are supplied directly to the Customer by the Partner Caterers on behalf of FoodieBee.",
            "5.2. The delivery takes place in the period selected by the Customer and confirmed by FoodieBee.",
        ...
        },
        {
          ...
          descrip: [
            ...
            "8.2. Meals may contain allergens. These are stated accordingly on the website. Please contact the FoodieBee customer service for more precise information on allergens."
          ]
        },
        {
          title:
        ...
        },
        {
          ...
          descrip: [
            ...
            "11.1.1 FoodieBee does not exclude or limit in any way our liability to you where it would be unlawful to do so. This includes liability for death or personal injury caused by our negligence of our employees, agents or subcontractors; for fraud or fraudulent misrepresentation; for breach of your legal rights in relation to the Catering Services.",
            "11.1.2 FoodieBee is responsible to you for foreseeable loss and damage caused by us. If we fail to comply with these T&Cs, we are responsible for loss or damage you suffer that is a foreseeable result of our breaking this contract or failing to use reasonable care and skill, but we are not responsible for any loss or damage which is not foreseeable. Loss or damage is foreseeable if either it is obvious that it will happen or if, at the time the contract was made, both we and you knew it might happen, for example, if you discussed it with us during the sales process.",
            "11.1.3 FoodieBee is not liable for business losses. We only supply the Catering Services to you for domestic and private use. If you use the Catering Services for any commercial, business or re-sale purpose, our liability to you will be limited as set out in term 11.2.",
            ...
            "Otherwise, FoodieBee liability shall limited to the order value."
          ]
        },
        {
        ...
        },
        {
          ...
          descrip: [
            "13.1 FoodieBee will only use your personal information as set out in our fair processing notice accessible: Privacy Policy"
          ]
        },
        {
  ...
  render() {
    return (
      ...
      >
        <Container>
          <Row>
            <Col style={{ textAlign: "start", marginTop: 50 }} xs="12">
